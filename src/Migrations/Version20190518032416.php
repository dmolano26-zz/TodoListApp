 ...
 */
final class Version20190518032416 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE usuario (id INT NOT NULL, persona_id INT NOT NULL, username VARCHAR(50) NOT NULL, password VARCHAR(50) NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_8DF2BD063397707A ON actividad (categoria_id)');
